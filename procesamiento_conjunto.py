...
archivos = ['notas1_procesado.xlsx', 'notas2_procesado.xlsx', 'notas3_procesado.xlsx',
           'notas4_procesado.xlsx', 'notas5_procesado.xlsx', 'notas6_procesado.xlsx']

# Leer y concatenar todos los DataFrames
df_list = [pd.read_excel(archivo) for archivo in archivos]
df = pd.concat(df_list, ignore_index=True)

# Estadísticas descriptivas generales para las calificaciones del los parciales y la nota final
calificaciones = ['parcial_1', 'parcial_2', 'nota_final']

# Calcular estadísticas descriptivas para las calificaciones
...
# Histograma para las calificaciones del Parcial 1
plt.figure(figsize=(10, 6))
sns.histplot(df['parcial_1'], bins=10, kde=False)
plt.title('Histograma de Calificaciones - Parcial 1')
plt.xlabel('Calificación')
plt.ylabel('Frecuencia')
plt.grid(True)
plt.savefig('histograma_parcial_1.png')
plt.show()

# Histograma para las calificaciones del Parcial 2
plt.figure(figsize=(10, 6))
sns.histplot(df['parcial_2'], bins=10, kde=False)
plt.title('Histograma de Calificaciones - Parcial 2')
plt.xlabel('Calificación')
plt.ylabel('Frecuencia')
plt.grid(True)
plt.savefig('histograma_parcial_2.png')
plt.show()
